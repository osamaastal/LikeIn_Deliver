...
public class Req_Canceled_Admin extends Fragment {
    ...
    public Req_Canceled_Admin() {
        // Required empty public constructor
    }

    public static Req_Canceled_Admin newInstance(String param1, String param2) {
        Req_Canceled_Admin fragment = new Req_Canceled_Admin();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.layout_f_req_canceled_admin, container, false);
        ...
        request.GetReqCanceled(getContext(),8,req_canceled_RV,"detail",Req_Canceled_Admin.this,progressBar);

// request.GetReqCanceled(getContext(),9,req_canceled_RV,"detail",Req_Canceled_Admin.this);
        /******************************************************/
        ...
        refreshFrag_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.detach(Req_Canceled_Admin.this).attach(Req_Canceled_Admin.this).commit();
            }
        });
        /************************************************************/
        return view;
